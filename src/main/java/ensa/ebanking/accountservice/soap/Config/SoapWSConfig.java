...
public class SoapWSConfig extends WsConfigurerAdapter {
    ...
    public DefaultWsdl11Definition defaultWsdl11Definition(XsdSchema schema) {
        ...
        defaultWsdl11Definition.setLocationUri("/cmi");
        defaultWsdl11Definition.setTargetNamespace("http://ebanking.ensa/accountservice/Soap/Request");
    ...
    public XsdSchema schema() {
        return new SimpleXsdSchema(new ClassPathResource("xmlSchemas.xsd"));
    }
